    ...
    <div className={styles["history-element"]}>
      {isEditing ? (
        <input
          ...
          className={styles["history-element-input"]}
        />
      ) : (
        <button
      ...
      <div className={styles["history-element-control"]}>
        {isEditing ? (
          <button
            className={styles["history-element-save"]}
            onClick={() => saveName(chat._id)}
          >
            <SaveIcon />
          </button>
        ) : (
          <button
            className={styles["history-element-edit"]}
        ...
        <button
          className={styles["history-element-remove"]}
